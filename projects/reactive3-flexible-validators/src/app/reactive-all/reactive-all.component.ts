...
import {ErrorMsgMap, makeDirty, MyValidatorsModule} from '@gpeel/validators';
import {TypicalValidatorsService} from '../validators/typical-validators.service';
import {CvaComboComponent} from './cva-combo.component';
import {InterfaceStyleEnum, SubscriptionOptions, UserData} from './user-data';

@Component({
  selector: 'reactive-all',
  standalone : true,
  imports: [CommonModule, MyValidatorsModule, CvaComboComponent, ReactiveFormsModule],
